...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult AgregarCarrito(int idproducto) {
            ...
            if (existe)
            {
                mensaje = "El producto seleccionado ya existe en el carrito";
            }
            else
            {
        ...
        public JsonResult ObtenerDistrito(string IdCanton, string IdProvincia)
        {
            ...
            oLista = new CN_Ubicacion().ObtenerDistrito(IdCanton,IdProvincia);
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta) {
            ...
            foreach (Carrito oCarrito in oListaCarrito)
            {
                ...
                oListaItem.Add(new Item()
                {
                    ...
                    {
                        currency_code = "USD",
                        value = oCarrito.oProducto.Precio.ToString("G", new CultureInfo("es-CR"))
                    }
